...
type TodoInterface interface {
	...
	Delete(string) (models.DeleteTodo, error)
...
func (c *TodoClient) Insert(todoItem models.Todo) (models.Todo, error) {
	createdTodo := models.Todo{}

	res, err := c.Col.InsertOne(c.Ctx, todoItem)
	if err != nil {
...
func (c *TodoClient) Update(id string, todoItem interface{}) (models.TodoUpdate, error) {
	...
	change := todoItem.(map[string]interface{})
...
func (c *TodoClient) Delete(id string) (models.DeleteTodo, error) {
	deletedTodo := models.DeleteTodo{
		DeletedCount: 0,
	}
	_id, err := primitive.ObjectIDFromHex(id)
	if err != nil {
	...
	deletedTodo.DeletedCount = int(res.DeletedCount)
